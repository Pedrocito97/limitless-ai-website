        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              >
                Support@limitlessai.online
              </a>
            </div>
            <div className="flex items-center space-x-4">
              <MapPin className="w-5 h-5 text-accent-cyan" />
              <span className="text-muted">
                1B Halford St, Leicester LE1 1JA, UK
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted hover:text-white hover:bg-white/10 hover:border-white/20 transition-all"
